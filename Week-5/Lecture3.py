...
Disk buffers
    ...
    “Buffer” is a temporary parking place for disk
    data
...
Reading Files
  ...
  open() readline() readline()
    ...
    block = fh.read(12) — read a fixed number of
    characters
...
End of file
    ...
    When reading incrementally, important to know
    when file has ended
...
Summary
    ...
    Open a file in one of three modes — read, write,
    append
