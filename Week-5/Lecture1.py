...
Exception handling
    ...
    If something goes wrong, provide “corrective
    action”

        File not found — display a message and ask
        user to retype filename

        List index out of bounds — provide diagnostic
        information to help debug error
...
Types of errors
    ...
    Most common error, invalid Python code
        ...
        SyntaxError: invalid syntax
            ...
            We are interested in errors that occur when
...
Terminology
    ...
    Raise an exception
        ...
        Run time error → signal error type, with
    ...
    Handle an exception
        ...
        Anticipate and take corrective action based on
        error type
...
Flow of control
    ...
    x = f(y,z)
        ...
        def f(a,b):  ⟵ IndexError inherited from f( ) ⟶ Not handled? Abort!
        ..
        g(a)     ⟵ IndexError inherited from g( ) ⟶ Not handled?

            def g(m):
            ..
            h(m)     ⟵ IndexError inherited from h( ) ⟶ Not handled?
                def h(s):
                ..
